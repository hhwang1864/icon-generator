...
const GeneratePage: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Generate Your personal Icons</title>
      ...
      <main className="container mx-auto mt-24 flex min-h-screen flex-col gap-4 px-8">
        ...
        <p className="mb-12 text-2xl">
          Please fill out below for your personal icons.
        </p>
        <form className="flex flex-col gap-4" onSubmit={handleFormSubmit}>
          <h2 className="text-xl">
            1. Describe what your icons look like.
          </h2>
          ...
          <h2 className="text-xl">5. Number of icons.</h2>
          <FormGroup className="mb-12">
